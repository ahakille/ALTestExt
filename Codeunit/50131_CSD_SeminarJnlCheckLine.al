codeunit 50131 "CSD Seminar jnl.-check Line"
{
    ...
    var
        ...
        PostingDateTxt: Label 'Is not within your range of alowed posting dates';
    ...
    procedure RunCheck(var SemJnIline: Record "CSD Seminar Journal Line");
    begin
        with SemJnIline do begin
            if EmptyLine() then
                exit;
